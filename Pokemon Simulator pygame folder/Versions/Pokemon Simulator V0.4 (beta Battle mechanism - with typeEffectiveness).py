...
class pokemon(object):
    def __init__(self, name, type, type2, moves, movePowerList, attack, defense, health, speed, level):
      self.name = name
      self.type = type
      self.type2 = type2
      self.moves = moves
    ...
    def fight(self, Pokemon2):
      ...
      while inBattle == True:
          ...
          if selectedMove == True:
            ...
            #print("CRITICAL THRESHOLD: " + str(criticalThreshold))
            #print("CRITICAL: " + str(criticalRandom))
            ...
            print("ENEMY HP: " + str(Pokemon2.health))
...
#-----------------POKEMON-----------------
wildLevel = 5
Pikachu = pokemon("Pikachu", "Electric", "", ["quick attack", "Thunder wave", "Thundershock", "Tackle"], [40, 0, 40, 50], 55, 30, 35, 90, wildLevel)
Charmander = pokemon("Charmander", "Fire", "", ["Tackle", "Ember", "Scratch", "Growl"], [50, 40, 40, 0], 55, 30, 35, 65, wildLevel)
Bulbasaur = pokemon("Bulbasaur", "Grass", "Poison", ["Tackle", "Razor leaf", "Sleep powder", "Growl"], [30, 39], 55, 30, 35, 45, wildLevel)
Squirtle = pokemon("Squirtle", "Water", "", ["Tackle", "Bubble", "Scratch", "Growl"], [30, 39], 48, 65, 44, 43, wildLevel)
