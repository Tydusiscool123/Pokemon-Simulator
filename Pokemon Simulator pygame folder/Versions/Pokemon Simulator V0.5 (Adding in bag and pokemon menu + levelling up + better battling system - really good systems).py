...
ballIndex = 0
index = 0
ballList = [ballType, "Great Ball", "Ultra Ball", "Master Ball", "Priemer Ball", "Dusk Ball"]
#ballSpriteList = []
...
class pokemon(object):
    ...
    def printBattleBG(self, Pokemon2):
      ...
      HPText = font2.render(HPString, 1, (0, 0, 0))
    ...
    def screenCheck(self, Pokemon2):
      ...
      if battleScreen == True:
        ...
        if menuSelectD == True:
          ...
          if down and right == True:
            ...
            screenPrint(text, 24, 270, (255, 255, 255), True, font)
      ...
      while bagScreen == True:
        ...
        ballTypeText = ballList[ballIndex]
      ...
      elif bagScreen == True or pokeScreen == True:
        pass
      ...
      if bagScreen == False or pokeScreen == False:
        #Display the pointer
        win.blit(Pointer2, (menuPosX + P_offsetX, menuPosY + P_offsetY))
        pygame.display.update()
    ...
    def catch(self, Pokemon2):
      ...
      self.printBattleBG(Pokemon2)
      screenPrint("You threw a " + ballList[ballIndex].upper() + "!", 24, 270, (255, 255, 255), True, font)
      ...
      if pokeCaught == True:
        #Printing information
        self.printBattleBG(Pokemon2)
        screenPrint("You caught a " + Pokemon2.name.upper() + "!", 24, 270, (255, 255, 255), True, font)
        pygame.time.delay(500)
      ...
      #Not catching Pokemon and continuing battle
        ...
        #Printing information
        self.printBattleBG(Pokemon2)
        screenPrint("You suck lmao", 24, 270, (255, 255, 255), True, font)
        pygame.time.delay(500)
        self.printBattleBG(Pokemon2)
    ...
    def damageCalculation(self, Pokemon2, pokeMove, movePower, moveType, user):
      ...
      screenPrint(upperText, 24, 270, (255, 255, 255), True, font)
      screenPrint(lowerText, 24, 300, (255, 255, 255), True, font)
      if user == False:
      ...
      if pokeMove == "Growl" or pokeMove == "Thunder wave" or pokeMove == "Sleep powder":
        ...
        #Print the text and delay
        screenPrint(text, 24, 270, (255, 255, 255), True, font)
        screenPrint(text2, 24, 300, (255, 255, 255), True, font)
        pygame.time.delay(500)    
      ...
      while inBattle == True:
        ...
        if Pokemon2.HP <= 0:
          ...
          for i,k in enumerate(trainerPartyList):
            ...
            self.printBattleBG(Pokemon2)
            screenPrint(k.name + " levelled up to " + str(k.level), 24, 270, (255, 255, 255), True, font)
            k.statsCheck()
        ...
        for event in pygame.event.get():
          ...
          if selectedMove == True:
            ...
            if userSleep or enemySleep == True:
  ...
  while drawing == True:
    ...
    for event in pygame.event.get():
      if event.type == QUIT:
        ...
        drawing = False
        pass
    #print("LENGTHDEFICIT: "+ str(lengthDeficit))
    #print("BARLENGTH: " + str(barLength))
...
#-----------------POKEMON-----------------
wildLevel = 5
Pikachu = pokemon("Pikachu", "Electric", "", ["quick attack", "Thunder wave", "Thundershock", "Tackle"], [40, 0, 40, 50], [30, 20, 30, 35], [30, 20, 30, 35], 55, 30, 35, 90, wildLevel, 190)
...
Bulbasaur = pokemon("Bulbasaur", "Grass", "Poison", ["Tackle", "Razor leaf", "Sleep powder", "Growl"], [50, 55, 0, 0], [35, 25, 15, 40], [35, 25, 15, 40], 55, 30, 35, 45, wildLevel, 190)
...
while ask == True:
  ...
  if userInput == "25":
    trainerPokemon = pokemon("Pikachu", "Electric", "", ["quick attack", "Thunder wave", "Thundershock", "Tackle"], [40, 0, 40, 50], [30, 20, 30, 35], [30, 20, 30, 35], 55, 30, 35, 90, wildLevel, 190)
    ask = False
  if userInput == "1":
    trainerPokemon = pokemon("Bulbasaur", "Grass", "Poison", ["Tackle", "Razor leaf", "Sleep powder", "Growl"], [50, 55, 0, 0], [35, 25, 15, 40], [35, 25, 15, 40], 55, 30, 35, 45, wildLevel, 190)
    ask = False
  if userInput == "2":
  ...
  if userInput == "3":
    ...
    ask = False
trainerPokemon2 = Pikachu
trainerPokemon3 = Pikachu
trainerPokemon4 = Pikachu
trainerPokemon5 = Pikachu
trainerPokemon6 = Pikachu
potentialPokemonList = [trainerPokemon2, trainerPokemon3, trainerPokemon4, trainerPokemon5, trainerPokemon6]
...
while run:
  ...
  if encounter == True:
    ...
    if wildPokemon.name == "Pikachu":
      wildPokemon = pokemon("Pikachu", "Electric", "", ["quick attack", "Thunder wave", "Thundershock", "Tackle"], [40, 0, 40, 50], [30, 20, 30, 35], [30, 20, 30, 35], 55, 30, 35, 90, wildLevel, 190)
    if wildPokemon.name == "Bulbasaur":
      wildPokemon = pokemon("Bulbasaur", "Grass", "Poison", ["Tackle", "Razor leaf", "Sleep powder", "Growl"], [50, 55, 0, 0], [35, 25, 15, 40], [35, 25, 15, 40], 55, 30, 35, 45, wildLevel, 190)
